...
public abstract class SharedSkillSystem : EntitySystem
{
    ...
    const bool lowpop = false; // СѓСЃР»РѕРІРЅРѕ РїРѕРєР° С‚Р°Рє Р±СѓРґРµС‚ РѕРєРґР°
        ...
        [NotNullWhen(false)] out string? error)
    {
        ...
        {
            if (true) // СЃРѕРѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕ РїРѕСЃР»Рµ РґРѕР±Р°РІР»РµРЅРёСЏ СЃРІРѕР№СЃС‚РІР° РґРѕР»Р¶РЅР° Р±С‹С‚СЊ Р»РѕРіРёРєР° РЅР° РїСЂРѕРІРµСЂРєСѓ Р·Р°Р±Р»РѕРєРёСЂРѕРІР°РЅРЅС‹С… РґР¶РѕР±РѕРє
                return true;
