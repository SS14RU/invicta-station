...
tips-dataset-32 = Будучи предателем, прослушивание важных каналов связи, таких как Департамент Шерифа или инженернов, может дать ценные сведения. Имейте в виду, что это происходит в обоих направлениях - Департамент Шерифа также может прослушивать канал связи Синдиката!
...
tips-dataset-65 = Занимаясь судебным делом, если наказание кажется вам слишком суровым, попытайтесь обсудить это со бейлифом.
tips-dataset-66 = Будучи сотрудником Департамента Шерифа, общайтесь и координируйте свои действия с коллегами при помощи радиоканала Департамента Шерифа, чтобы избежать неразберихи.
tips-dataset-67 = Как сотрудник Департамента Шерифа помните — подозрений мало для обвинений. Возможно кто-то просто оказался не в том месте и не в то время!
tips-dataset-68 = Будучи следовательом, вы можете более эффективно разыскивать преступников, опираясь на данные об оставленных им отпечатках пальцев и волокнах - сканируйте предметы с которым тот мог взаимодействовать.
...
tips-dataset-112 = Имея дело со Департаментом Шерифа, вы часто можете избежать своего приговора за счёт сотрудничества или обмана.
...
tips-dataset-139 = Обязательно протирайте незаконные имплантанты с мылом или влажной тряпкой после их использования! Следовательы могут сканировать использованные имплантанты на предмет наличия улик ДНК, но только в том случае, если они были тщательно вытерты.
