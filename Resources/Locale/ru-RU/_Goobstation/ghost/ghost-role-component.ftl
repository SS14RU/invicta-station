...
ghost-role-information-trevor-description = Боевой конь Департамента Шерифа.
...
ghost-role-information-bsd-name = Представитель СКН
ghost-role-information-bsd-description = Тебя вызвал на станцию представитель Корпорации, подчиняйся ему, защищай командование, следуй корпоративному закону.
ghost-role-information-bsd-rules = Следуй приказам, данным тебе [color=yellow][bold]Представителем Корпорации[/bold][/color], защищай командование.
# interns
...
justice-role-description = Помогай Шерифу с арестами, выкрикивая фразы пока тот совершает правосудиеe.
