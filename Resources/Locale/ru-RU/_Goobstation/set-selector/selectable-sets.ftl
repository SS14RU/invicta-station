...
selectable-set-security-voidsuit-name = пустотный скафандр Департамента Шерифа
...
selectable-set-headofsecurity-voidsuit-name = скафандр главы Департамента Шерифа
