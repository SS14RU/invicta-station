...
ntr-executive-bsd-name = Вызвать заместителя офицера СКН
ntr-executive-bsd-desc = Запросите заместителя офицера СКН с Центрального Командования. Этот личный охранник для вас или руководства требует веского обоснования. Можно вызвать только одного.
...
ntr-executive-ert-sec-desc = Запросите подразделение Департамента Шерифа из ОБР Центрального Командования. Применяется при чрезвычайных угрозах, таких как ядерные оперативники или революции. Злоупотребление приведёт к серьёзным последствиям.
