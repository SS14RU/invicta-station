...
loadout-group-bso-head = Голова офицера СКН
loadout-group-bso-backpack = Рюкзак офицера СКН
loadout-group-bso-jumpsuit = Комбинезон офицера СКН
loadout-group-bso-mask = Маска офицера СКН
loadout-group-bso-outer = Броня офицера СКН
loadout-group-bso-neck = Ожерелье офицера СКН
loadout-group-bso-shoes = Обувь офицера СКН
...
loadout-group-security-neck = Ожерелье Департамента Шерифа
...
loadout-group-hos-shoes = Глава Департамента Шерифа, обувь
...
loadout-group-security-melee = Департамент Шерифа, оружие ближнего боя
