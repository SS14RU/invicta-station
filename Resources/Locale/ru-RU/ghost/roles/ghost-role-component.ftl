...
ghost-role-information-security-name = Департамент Шерифа
ghost-role-information-security-description = Вы входите в состав оперативной группы Департамента Шерифа, но, похоже, попали в странную ситуацию...
...
ghost-role-information-pirate-description = Агх, дружище! Собирайте крутые трофеи, но старайтесь избегать Департамента Шерифа и утилизаторов!
ghost-role-information-pirate-captain-name = Капитан космических пиратов
ghost-role-information-pirate-captain-description = Агх, дружище! Ты здесь главный, и тебе нужно разработать план, как заполучить эту сочную добычу с помощью крючка или мошенничества. Только постарайтесь избегать Департамента Шерифа и утилизаторов!
