...
job-description-brigmedic = Боритесь за жизни своих товарищей в тылу Департамента Шерифа! Вы - первая и последняя надежда своего отряда. Да благословит вас Гиппократ.
...
job-description-hos = Управляйте своими сотрудниками Департамента Шерифа и следите за их эффективностью, подавляйте инакомыслие и обеспечивайте безопасность других глав.
...
job-description-warden = Патрулируйте Департамент Шерифа, следите за тем, чтобы никто не воровал из оружейной, и чтобы все заключённые были оформлены и выпущены по окончании срока.
