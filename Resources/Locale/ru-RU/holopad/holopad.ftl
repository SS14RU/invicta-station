...
holopad-medical-paramedic = Медицинский - Полевой медицинский специалист
...
holopad-security-lawyer = ДШ - Адвокат
holopad-security-armory = ДШ - Оружейная
holopad-security-locker-room = ДШ - Раздевалка
holopad-security-brig-med = ДШ - Бригмед
holopad-security-evac-checkpoint = ДШ - КПП Эвакуация
holopad-security-arrivals-checkpoint = ДШ - КПП Прибытие
# Service
