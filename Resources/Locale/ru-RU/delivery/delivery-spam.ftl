...
delivery-spam-alternate-timeline =
    ...
    { "[head=2]Это официальное уведомление [color=red]Начальника Департамента Шерифа[/color] Космической станции 15 Nanotrasen.[/head]" }
    
    Кому бы ни попало это письмо... Я сержант Ригель, начальник Департамента Шерифа. Нам срочно нужно подкрепление.
