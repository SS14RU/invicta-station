...
ent-ClothingUniformEnvirosuitDetective = экокостюм следовательа
    .desc = Проект для особенно изысканного плазмалюда, модифицированный Nanotrasen для следовательов.
...
ent-ClothingUniformEnvirosuitHoS = экокостюм гсб
    .desc = Контейнерный костюм для плазмалюдов, занявших должность главы Департамента Шерифа.
...
ent-ClothingUniformEnvirosuitWarden = экокостюм бейлифа
    .desc = Контейнерный костюм для бейлифа, с белыми полосами для отличия от других охранников.
...
ent-ClothingUniformEnvirosuitBlueshield = экокостюм СКН
    .desc = Экокостюм для плазмалюдов, работающих в Службе корпоративного надзора.
