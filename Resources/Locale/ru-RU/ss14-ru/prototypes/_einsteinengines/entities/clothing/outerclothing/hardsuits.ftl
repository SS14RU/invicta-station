...
ent-ClothingOuterHardsuitCombatOfficer = боевой скафандр Департамента Шерифа
    .desc = Специально разработанный боевой костюм, предназначенный для защиты пользователя от любого рода противников в условиях пониженного давления. Этот экземпляр отмечен символикой Департамента Шерифа станции.
