...
ent-ClothingHeadEnvirohelmDetective = экошлем следовательа
    .desc = Специальный герметичный шлем для следовательов, защищающий от ожогов и других неприятностей.
...
ent-ClothingHeadEnvirohelmHoS = экошлем гсб
    .desc = Специальный герметичный шлем для главы Департамента Шерифа. Пара золотых полос отличает его от остальных сотрудников безопасности.
...
ent-ClothingHeadEnvirohelmSecBlue = синий экошлем сб
    .desc = Голубой экошлем для Департамента Шерифа плазмалюдей.
ent-ClothingHeadEnvirohelmSecGrey = серый экошлем сб
    .desc = Светло-серый экошлем с ярко-красными акцентами для Департамента Шерифа плазмалюдей.
...
ent-ClothingHeadEnvirohelmWarden = экошлем бейлифа
    .desc = Герметичный шлем плазмалюда для бейлифа. Добавлена пара белых полос, чтобы отличать от других сотрудников безопасности.
...
ent-ClothingHeadEnvirohelmBlueshield = экошлем СКН
    .desc = Экошлем для плазмалюда, предназначенный для службы корпоративного надзора.
