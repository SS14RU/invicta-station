...
ent-ClothingUniformJumpsuitBlueshieldOfficer = комбинезон офицера СКН
    .desc = Серо-голубой комбинезон с короткими рукавами из прочного материала. Стандартное снаряжение офицера СКН.
ent-ClothingUniformJumpsuitBlueshieldShirt = синяя рубашка офицера СКН
    .desc = Официальная форма службы корпоративного надзора. Надёжная и загруженная.
...
ent-ClothingUniformJumpsuitHoSSummer = летняя рубашка Шерифа
    .desc = Индивидуальный летний наряд главы Департамента Шерифа, на случай, если становится жарко во время погони за грейтайдами.
