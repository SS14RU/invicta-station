...
ent-ClothingHeadHatBeretBlueshield = берет офицера СКН
...
ent-ClothingHeadHatUshankaBlueshield = бронеушанка СКН
...
ent-ClothingHeadHatBeretHeadOfSecurityAdvanced = парадный берет главы Департамента Шерифа
    .desc = Особенно украшенный берет, предназначенный для начальника Департамента Шерифа.
