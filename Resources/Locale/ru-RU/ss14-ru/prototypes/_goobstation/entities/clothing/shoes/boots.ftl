...
ent-ClothingShoesBootsJackAdvanced = продвинутые офицерские сапоги
    .desc = Магпространственно усиленные боевые ботинки безопасности NanoTrasen для боевых операций. Эта пара предназначена для начальника Департамента Шерифа.
...
ent-ClothingShoesBootsWinterSnowjackBso = зимние ботинки СКН
...
ent-ClothingShoesWinterCombatBoots = боевые снежные ботинки
    .desc = Боевые ботинки Департамента Шерифа NanoTrasen для боевых ситуаций. Теперь в зимнем исполнении.
