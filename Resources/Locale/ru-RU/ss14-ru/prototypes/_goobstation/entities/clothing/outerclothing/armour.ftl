...
ent-ClothingOuterArmorHoSVestWeb = бронежилет главы Департамента Шерифа
...
ent-ClothingBlueshieldArmourVest = бронежилет СКН
    .desc = Бронированный жилет с символикой СКН.
ent-ClothingBlueshieldArmoredJacket = бронированная куртка СКН
    .desc = Куртка с вшитыми слоями усиления.
ent-ClothingBlueshieldArmoredCowboyJacket = бронированная ковбойская куртка СКН
    .desc = Куртка для защиты важных людей в опасных районах.
ent-ClothingOuterWinterBlueshield = бронированная зимняя куртка СКН
