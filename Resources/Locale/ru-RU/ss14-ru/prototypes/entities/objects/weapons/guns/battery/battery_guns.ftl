...
ent-WeaponLaserCarbine = лазерная винтовка
    .desc = Предпочитается Департаментом Шерифа Nanotrasen за дешевизну и простоту использования.
    .suffix = Винтовка
...
ent-WeaponTaser = тазер
    .desc = Электрошокер малой мощности, используемый Департаментом Шерифа для подавления целей на расстоянии.
    .suffix = Пистолет
