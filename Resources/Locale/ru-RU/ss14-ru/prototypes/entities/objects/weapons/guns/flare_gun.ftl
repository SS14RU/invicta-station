...
ent-WeaponFlareGunSecurity = сигнальное ружьё
    .desc = Модифицированный сигнальный пистолет, изначально предназначенный для использования Департаментом Шерифа для запуска нелетальных ружейных снарядов. Однако он также может без риска стрелять и летальными снарядами.
