...
ent-SecurityCadetPDA = КПК кадета
...
ent-ParamedicPDA = КПК полевого медицинского специалиста
    .desc = Блестящий и стерильный КПК полевого медицинского специалиста.
...
ent-HoSPDA = КПК главы Департамента Шерифа
    .desc = Носитель данного КПК — закон.
ent-WardenPDA = КПК бейлифа
    .desc = Похоже, что на ОС был установлен джейлбрейк.
ent-SecurityPDA = КПК офицера-патрульного
...
ent-DetectivePDA = КПК следовательа
...
ent-SeniorOfficerPDA = КПК лейтенанта
