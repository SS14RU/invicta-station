...
ent-ComputerCriminalRecords = консоль криминальных записей
    .desc = Её можно использовать для проверки судимостей. Редактировать их может только Департамент Шерифа.
...
ent-ComputerCargoOrdersSecurity = охранная консоль заказа грузов
    .desc = Используется Департаментом Шерифа для заказа припасов.
