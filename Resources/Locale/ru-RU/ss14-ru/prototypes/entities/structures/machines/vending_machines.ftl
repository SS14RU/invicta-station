...
ent-VendingMachineSec = СБТех
    .desc = Торговый автомат с экипировкой ДШ. На табличке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ СЛУЖБЫ БЕЗОПАСНОСТИ".
...
ent-VendingMachineDetDrobe = ДетекШкаф
    .desc = Машина для всех ваших следовательных нужд, до тех пор, пока вам нужна одежда.
