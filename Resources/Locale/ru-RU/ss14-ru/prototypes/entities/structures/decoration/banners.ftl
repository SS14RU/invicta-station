...
ent-BannerSecurity = знамя Департамента Шерифа
    .desc = Это знамя, на котором представлены цвета Департамента Шерифа. Вы удивлены, что его ещё никто не испортил.
