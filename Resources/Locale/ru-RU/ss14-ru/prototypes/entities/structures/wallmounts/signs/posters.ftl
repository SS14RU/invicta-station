...
ent-PosterContrabandFunPolice = Шуты в ДШ
...
ent-PosterLegitHereForYourSafety = Здесь для вашей безопасности
    .desc = Плакат, восхваляющий Департамент Шерифа станции.
...
ent-PosterLegitSafetyReport = Техника безопасности: донесения
    .desc = Плакат, инструктирующий зрителя сообщать о подозрительной активности в Департамент Шерифа.
ent-PosterLegitReportCrimes = Сообщай обо всём!
    .desc = Плакат, призывающий оперативно сообщать о преступлениях или подстрекательских действиях в Департамент Шерифа станции.
...
ent-PosterLegitDickGumshue = Дик Гамшу
    .desc = Плакат, рекламирующий приключения Дика Гамшу, мышиного следовательа. Призывает команду обрушить всю мощь правосудия на саботажников проводов.
...
ent-PosterLegitSecWatch = ДШ видит
