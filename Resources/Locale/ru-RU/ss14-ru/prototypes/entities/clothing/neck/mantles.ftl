...
ent-ClothingNeckMantleHOS = мантия главы Департамента Шерифа
    .desc = Перестрелки с оперативниками — это просто очередной вторник для этого Шерифа. Эта мантия — символ преданности станции.
