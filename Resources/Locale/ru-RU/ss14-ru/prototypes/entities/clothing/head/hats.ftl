...
ent-ClothingHeadHatBeretSecurity = берет охраны
    .desc = Стильный вариант одежды для сотрудников Департамента Шерифа.
...
ent-ClothingHeadHatHoshat = шляпа главы Департамента Шерифа
    .desc = Верная фуражка стандартного образца начальника Департамента Шерифа. Чтобы показать офицерам, кто здесь командует.
