...
ent-ClothingOuterHardsuitSecurity = скафандр Департамента Шерифа
    .desc = Специальный костюм, защищающий от опасной среды с низким давлением. Имеет дополнительный слой брони.
ent-ClothingOuterHardsuitSecurityRed = скафандр главы Департамента Шерифа
    .desc = Специальный костюм, защищающий от опасной среды с низким давлением. Имеет дополнительный слой брони.
ent-ClothingOuterHardsuitBrigmedic = скафандр бригмедика
    .desc = Специальный скафандр ангела-хранителя брига. Это медицинская версия скафандра Департамента Шерифа.
ent-ClothingOuterHardsuitWarden = скафандр бейлифа
