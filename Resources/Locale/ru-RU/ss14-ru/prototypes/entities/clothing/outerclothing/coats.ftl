...
ent-ClothingOuterCoatDetective = тренч следовательа
...
ent-ClothingOuterCoatDetectiveLoadoutGrey = нуарный тренчкот
    .desc = Ах, ваш верный тренчкот. Пара прорех тут и там придают ему более соответствующий следовательу вид. По крайней мере, так вы сказали себе, когда узнали, что починка обойдется вам в 200 кредитов.
...
ent-ClothingOuterCoatParamedicWB = ветровка полевого медицинского специалиста
    .desc = Надёжная ветровка полевого медицинского специалиста, защита от любого космического ветра.
