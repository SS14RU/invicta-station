...
ent-ClothingUniformJumpskirtHoS = юбка-комбинезон главы Департамента Шерифа
    .desc = Она ярко-красная и хрустящая, как и многие жертвы Департамента Шерифа.
ent-ClothingUniformJumpskirtHoSAlt = юбка-водолазка главы Департамента Шерифа
    .desc = Это водолазка, носимая теми, кто достаточно силён и дисциплинирован, чтобы достичь должности главы Департамента Шерифа. Её прочная ткань обеспечивает слабую защиту от механических повреждений.
...
ent-ClothingUniformJumpskirtParamedic = юбка-комбинезон полевого медицинского специалиста
    .desc = Униформа полевого медицинского специалиста в формате юбки-комбинезона.
...
ent-ClothingUniformJumpskirtSeniorOfficer = юбка-комбинезон лейтенанта
    .desc = Признак мастерства и престижа Департамента Шерифа.
ent-ClothingUniformJumpskirtSecGrey = серая юбка-комбинезон Департамента Шерифа
