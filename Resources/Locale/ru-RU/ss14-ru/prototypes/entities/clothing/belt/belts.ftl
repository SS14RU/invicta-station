...
ent-ClothingBeltSecurity = пояс охраны
    .desc = Может вмещать различное снаряжение Департамента Шерифа, такое как наручники и вспышки.
...
ent-ClothingBeltSecurityWebbing = РПС охраны
    .desc = Уникальный, универсальный разгрузочный жилет с ремнями и поясом, может вмещать снаряжение Департамента Шерифа.
