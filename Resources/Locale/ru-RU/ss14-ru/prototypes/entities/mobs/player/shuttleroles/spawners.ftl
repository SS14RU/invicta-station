...
ent-VisitorHOPSpawner = спавнер посетитель ГП
    .desc = { ent-MarkerBase.desc }
ent-VisitorHOSSpawner = спавнер посетитель Шериф
    .desc = { ent-MarkerBase.desc }
ent-VisitorRDSpawner = спавнер посетитель НР
    .desc = { ent-MarkerBase.desc }
ent-VisitorQMSpawner = спавнер посетитель КМ
    .desc = { ent-MarkerBase.desc }
ent-SecurityVisitorSpawner = спавнер посетитель ДШ
    .desc = { ent-MarkerBase.desc }
ent-VisitorSecurityCadetSpawner = спавнер посетитель кадет
    .desc = { ent-MarkerBase.desc }
ent-VisitorSecurityOfficerSpawner = спавнер посетитель офицер-патрульный
    .desc = { ent-MarkerBase.desc }
ent-VisitorDetective = спавнер посетитель следователь
    .desc = { ent-MarkerBase.desc }
ent-VisitorWarden = спавнер посетитель бейлиф
    .desc = { ent-MarkerBase.desc }
