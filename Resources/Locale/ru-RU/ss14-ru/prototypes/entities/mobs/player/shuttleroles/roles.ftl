...
ent-RandomHumanoidVisitorHOP = посетитель ГП роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorHOS = посетитель Шериф роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorRD = посетитель НР роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorQM = посетитель КМ роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityCadet = посетитель кадет роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorSecurityOfficer = посетитель офицер-патрульный роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorDetective = посетитель следователь роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorWarden = посетитель бейлиф роль призрака
    .desc = { "" }
...
ent-RandomHumanoidChallengeVictimHOP = жертва катастрофы ГП роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
ent-RandomHumanoidChallengeVictimHOS = жертва катастрофы Шериф роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
