...
ent-ClothingUniformJumpsuitHoSBlack = чёрный комбинезон главы Департамента Шерифа
    .desc = Это чёрный костюм главы Департамента Шерифа.
...
ent-ClothingUniformJumpsuitPilot = комбинезон пилота Департамента Шерифа
    .desc = Это комбинезон пилота Департамента Шерифа.
