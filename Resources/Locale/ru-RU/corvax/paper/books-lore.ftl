...
book-zp-contents =
    ...
    Нахождение в заключении – 0. Отчет о времени заключения составляет бейлиф.
