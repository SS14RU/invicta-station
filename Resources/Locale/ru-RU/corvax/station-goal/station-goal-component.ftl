...
station-goal-security =
    ...
    Второстепенная цель — постройка и снабжение тренировочного комплекса для Департамента Шерифа, с последующей проверкой состава.[/bold]
...
station-goal-shuttle-sec =
    ...
    2. Уметь совершать следующие движения: крен, тангаж и рысканье.
    3. Доступ к используемому оборудованию внутри отсеков не должен быть затруднён.
    4. Иметь на борту места и снаряжение как минимум на пять офицеров-патрульных.
...
station-goal-bunker =
    ...
    Необходимо пристроить по комнате, далее именуемой как “бункер”, следующим отделам: Департамента Шерифа, Медицинскому и Командному. В них экипаж станции мог бы укрыться от последствий гиперэнергетических потоков.
    ...
    Бункер отдела Департамента Шерифа должен так же включать в себя два Силовика и три Раздатчика летальных ружейных патронов.
...
station-goal-astra-repair =
    ...
    Вам необходимо силами утилизаторов и Департамента Шерифа при необходимости (по запросу утилизаторов) избавиться от мешающей проведению работ враждебной фауны.
