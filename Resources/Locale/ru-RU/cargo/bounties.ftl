...
bounty-description-donut = Департамент Шерифа Центкома несёт большие потери в борьбе с Синдикатом. Отправьте пончики для поднятия боевого духа.
...
bounty-description-spear = Департамент Шерифа Центком переживает сокращение бюджета. Вам заплатят, если вы доставите набор копий.
...
bounty-description-rollerskates = Департамент Шерифа Центком предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
...
bounty-description-banana = Привет, станция! Ботаники не хотят мне больше ничего давать. Они сказали, что поскользнуть и выкинуть Шерифа в космос через открытый шлюз — это не смешно! Представляете? Помогите мне! ХОНК.
