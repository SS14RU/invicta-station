...
ent-ClothingHeadHatBizarreSoftFlipped = troublemaker's cap
    .desc = { ent-ClothingHeadHeadHatBaseFlipped.desc }
ent-ClothingHeadHatParamedicsoft = field medical specialist cap
    .desc = A blue cap for field medical specialists with a medical cross.
ent-ClothingHeadHatParamedicsoftFlipped = field medical specialist cap
    .desc = { ent-ClothingHeadHeadHatBaseFlipped.desc }
